...
// Data by state, needs to be categorised logically for each level of colour
// Data format? object? map the data to state:color, state:data
// hover data tooltip
// "stroke-[0.97063118] fill-slate-50"
...
const choroplethSVGData:StatesChoroplethSVGData  = {
                width:1000,
                height:589,
...
const DynamicSVGChoropleth = () => {

  // const { width, height } = useParentSize(elementRef, options);

  const allStyling = choroplethSVGData.allStatesStyling

  const { setShowInfoView} = useContext(stateInfoContext);
  
  const originalAspectRatio = 1000/589

  return(
            <svg
              xmlns="http://www.w3.org/2000/svg"
              id="svg"
              viewBox={`0 0 ${choroplethSVGData.width*2} ${choroplethSVGData.height*2}`}
              preserveAspectRatio = 'xMaxYMid meet'
              width={choroplethSVGData.width}
              height={choroplethSVGData.height}
              style={{
          ...
          {choroplethSVGData.states.map((state,i) => 
             ...
             { return(
              ...
              id= {state.stateCode}
              d= {state.dSVGData}
              data-id= {state.stateCode}
              data-name={state.stateName}
              className= {`${allStyling} ${state.color}`}
              // onMouseOver{(e )=>}
              >
                {/* <ChoroplethTooltip/> */}
              </path>
...
//   //     data-id="NE"
//   //     data-name="Nebraska"
//   //     className= {`${allStatesStyling} ${SVGColors.NE}`}
//   //   />
//   {
//     stateName:  ,
//     stateCode:  ,
...
//   //     data-id="OK"
//   //     data-name="Oklahoma"
//   //     className= {`${allStatesStyling} ${SVGColors.OK}`}
//   //   />
//   {
//     stateName:  ,
//     stateCode:  ,
...
//   //     className= {`${allStatesStyling} ${SVGColors.SD}`}
//   //   />
//   {
//     stateName:  ,
//     stateCode:  ,
...
//   //     data-id="LA"
//   //     data-name="Louisiana"
//   //     className= {`${allStatesStyling} ${SVGColors.LA}`}
//   //   />
//   {
//     stateName:  ,
//     stateCode:  ,
...
//   //     data-id="TX"
//   //     data-name="Texas"
//   //     className= {`${allStatesStyling} ${SVGColors.TX}`}
//   //   />
//   {
//     stateName:  ,
//     stateCode:  ,
...
//   //     className= {`${allStatesStyling} ${SVGColors.CT}`}
//   //   />
//   {
//     stateName:  ,
//     stateCode:  ,
...
//   //     className= {`${allStatesStyling} ${SVGColors.NH}`}
//   //   />
//   {
//     stateName:  ,
//     stateCode:  ,
...
//   //     className= {`${allStatesStyling} ${SVGColors.RI}`}
//   //   />
//   {
//     stateName:  ,
//     stateCode:  ,
...
//   //     data-id="VT"
//   //     data-name="Vermont"
//   //     className= {`${allStatesStyling} ${SVGColors.VT}`}
//   //   />
//   {
//     stateName:  ,
//     stateCode:  ,
...
//   //     data-id="AL"
//   //     data-name="Alabama"
//   //     className= {`${allStatesStyling} ${SVGColors.AL}`}
//   //     // onMouseOver={}
//   //   />
//   {
//     stateName:  ,
...
//   //     data-id="FL"
//   //     data-name="Florida"
//   //     className= {`${allStatesStyling} ${SVGColors.FL}`}
//   //   />
//   {
//     stateName:  ,
//     stateCode:  ,
...
//   //     data-id="GA"
//   //     data-name="Georgia"
//   //     className= {`${allStatesStyling} ${SVGColors.GA}`}
//   //   />
//   {
//     stateName:  ,
//     stateCode:  ,
...
//   //     className= {`${allStatesStyling} ${SVGColors.MS}`}
//   //   />
//   {
//     stateName:  ,
//     stateCode:  ,
...
//   //     className= {`${allStatesStyling} ${SVGColors.SC}`}
//   //   />
//   {
//     stateName:  ,
//     stateCode:  ,
...
//   //     data-id="IL"
//   //     data-name="Illinois"
//   //     className= {`${allStatesStyling} ${SVGColors.IL}`}
//   //   />
//   {
//     stateName:  ,
//     stateCode:  ,
...
//   //     data-id="IN"
//   //     data-name="Indiana"
//   //     className= {`${allStatesStyling} ${SVGColors.IN}`}
//   //   />
//   {
//     stateName:  ,
//     stateCode:  ,
...
//   //     data-id="KY"
//   //     data-name="Kentucky"
//   //     className= {`${allStatesStyling} ${SVGColors.KY}`}
//   //   />
//   {
//     stateName:  ,
//     stateCode:  ,
...
//   //     className= {`${allStatesStyling} ${SVGColors.NC}`}
//   //   />
//   {
//     stateName:  ,
//     stateCode:  ,
...
//   //     data-id="OH"
//   //     data-name="Ohio"
//   //     className= {`${allStatesStyling} ${SVGColors.OH}`}
//   //   />
//   {
//     stateName:  ,
//     stateCode:  ,
...
//   //     data-id="TN"
//   //     data-name="Tennessee"
//   //     className= {`${allStatesStyling} ${SVGColors.TN}`}
//   //   />
//   {
//     stateName:  ,
//     stateCode:  ,
...
//   //     data-id="VA"
//   //     data-name="Virginia"
//   //     className= {`${allStatesStyling} ${SVGColors.VA}`}
//   //   />
//   {
//     stateName:  ,
//     stateCode:  ,
...
//   //     data-id="WI"
//   //     data-name="Wisconsin"
//   //     className= {`${allStatesStyling} ${SVGColors.WI}`}
//   //   />
//   {
//     stateName:  ,
//     stateCode:  ,
...
//   //     className= {`${allStatesStyling} ${SVGColors.WV}`}
//   //   />
//   {
//     stateName:  ,
//     stateCode:  ,
...
//   //     data-id="DE"
//   //     data-name="Delaware"
//   //     className= {`${allStatesStyling} ${SVGColors.DE}`}
//   //   />
//   {
//     stateName:  ,
//     stateCode:  ,
...
//   //     className= {`${allStatesStyling} ${SVGColors.DC}`}
//   //   />
//   {
//     stateName:  ,
//     stateCode:  ,
...
//   //     data-id="MD"
//   //     data-name="Maryland"
//   //     className= {`${allStatesStyling} ${SVGColors.MD}`}
//   //   />
//   {
//     stateName:  ,
//     stateCode:  ,
...
//   //     className= {`${allStatesStyling} ${SVGColors.NJ}`}
//   //   />
//   {
//     stateName:  ,
//     stateCode:  ,
...
//   //     data-id="NY"
//   //     data-name="New York"
//   //     className= {`${allStatesStyling} ${SVGColors.NY}`}
//   //   />
//   {
//     stateName:  ,
//     stateCode:  ,
...
//   //     className= {`${allStatesStyling} ${SVGColors.PA}`}
//   //   />
//   {
//     stateName:  ,
//     stateCode:  ,
...
//   //     data-id="ME"
//   //     data-name="Maine"
//   //     className= {`${allStatesStyling} ${SVGColors.ME}`}
//   //   />
//   {
//     stateName:  ,
//     stateCode:  ,
...
//   //     data-id="MI"
//   //     data-name="Michigan"
//   //     className= {`${allStatesStyling} ${SVGColors.MI}`}
//   //   />
//   {
//     stateName:  ,
//     stateCode:  ,
...
//   //     data-id="AK"
//   //     data-name="Alaska"
//   //     className= {`${allStatesStyling} ${SVGColors.AK}`}
//   //   />
//   // </svg>
  // )
}
export default DynamicSVGChoropleth;
